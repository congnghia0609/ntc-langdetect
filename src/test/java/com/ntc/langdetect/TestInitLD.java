 ...
 */
public class TestInitLD {
    private static LangDetect ld;
    
    @BeforeClass
    public static void initTestInitLD() throws IOException {
        String pathLD = "src/main/resources/models/ld/langdetect-183.bin";
        ld = new LangDetect(pathLD);
    }
